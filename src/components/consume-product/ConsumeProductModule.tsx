...
export default function ConsumeProductModule({ title, consumption, image }: { title: string, consumption: ConsumeProd[], image: StrapiImage }) {
    ...
    return (
        <section className="bg-(--on-primary-container)  py-20 font-['Manrope']">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center justify-items-center">

                <div className="order-2 lg:order-1 rounded-3xl overflow-hidden shadow-xl md:w-100 w-90">
